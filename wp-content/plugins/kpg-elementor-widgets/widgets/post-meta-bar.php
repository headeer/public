...
class KPG_Elementor_Post_Meta_Bar_Widget extends Widget_Base {
	...
	protected function render() {
		...
		$right_section_classes = 'kpg-post-meta-right-section';
		if ( $show_date && ! $show_share ) {
			$right_section_classes .= ' kpg-post-meta-right-section--date-only';
		} elseif ( ! $show_date && $show_share ) {
			$right_section_classes .= ' kpg-post-meta-right-section--share-only';
		}
		...
		<div class="kpg-post-meta-bar">
			...
			<?php if ( $show_date || $show_share ) : ?>
				<div class="<?php echo esc_attr( $right_section_classes ); ?>">
					<!-- Center: Date -->
					<?php if ( $show_date ) : ?>
	...
	protected function content_template() {
		...
		<div class="kpg-post-meta-bar">
			<div class="kpg-post-meta-author-section">
				...
				<div class="kpg-post-meta-author-info">
					<span class="kpg-post-meta-author-label">autor</span>
					<span class="kpg-post-meta-author-name">Author Name</span>
				</div>
			</div>

			<# if (settings.show_date === 'yes' || settings.show_share === 'yes') { #>
				<div class="kpg-post-meta-right-section">
					<# if (settings.show_date === 'yes') { #>
						<div class="kpg-post-meta-date-section">
							<div class="kpg-post-meta-date-label">
								<span class="kpg-post-meta-date-text">Artykuł zgodny ze stanem prawnym na dzień:</span>
							</div>
							<span class="kpg-post-meta-date-value">23.12.2025</span>
						</div>
					<# } #>
